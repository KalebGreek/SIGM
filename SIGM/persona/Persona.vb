Class Persona
    ...
    Shared Function Seleccionar(ParentForm As Form, Optional vista As String = "PERSONA") As DataRowView
        Using SelPer As New ConsultaPersona With {.Owner = ParentForm}
            SelPer.genSearchControl1.vista.SelectedItem = vista
            SelPer.SelectPerson = True
            SelPer.ShowDialog()
            Return SelPer.PersonSelected
        End Using
    End Function
