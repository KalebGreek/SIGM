Sub deimp(ByVal keyword As String, ByVal impuesto As String)
        '### Cargar referencia de tablas
        tablas_fox(impuesto)
        '### Crear consulta sin filtros
    
        sel_sql = "SELECT " & ext_persona & ".codigo as codigo, " & ext_persona & ".razon as razon, " & col_importe & " as original, " & _
                  col_pagado & " as pagado, " & col_vence & " as vencimiento, " & col_periodo & " as periodo FROM " & ext_cuenta & _
