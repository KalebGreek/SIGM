Public Class Domicilio
	Shared Function Listar(persona_id As Integer) As DataTable
		Return DbMan.readDB(Nothing, My.Settings.CurrentDB, "SELECT per_domicilio.id as domicilio_id, per_domicilio.calle, per_domicilio.altura,
	...
	Shared Function Nuevo(persona_id As Integer, calle As String, altura As Integer, piso As Integer,
		...
		Dim dtab As DataTable = DbMan.readDB(Nothing, My.Settings.CurrentDB, "SELECT MAX(id) as id FROM per_domicilio WHERE per_id=" & persona_id)
		Return dtab(0)("id")
	End Function
