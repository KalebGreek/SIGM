Public Class Hacienda
	...
	Shared Function ConsolidarCuentas(fecha As Date) As Boolean
		'Todo sobre Fox
		My.Settings.DefaultCon = My.Settings.foxcon
		If MsgBoxResult.Yes = MsgBox("Se calculará al mes de " & fecha.ToString("y"),
			...
			'Reset
			DbMan.edit("UPDATE hacienda SET MES1=0, MES2=0, MES3=0, MES4=0, MES5=0, 
						MES6=0, MES7=0, MES8=0, MES9=0, MES10=0, MES11=0, MES12=0, 
						SUMATODO=0, GASTADO=0, GASTOMES=0")

			DbMan.edit("DELETE FROM ingresos") 'Fox no necesita comodín
			DbMan.edit("DELETE FROM egresos")

			'Actualizar desde movimis en Hacienda (ingresos)
			DbMan.edit("UPDATE hacienda SET hacienda.sumatodo=sq.ingreso
						FROM 
			...
			DbMan.edit("UPDATE hacienda SET hacienda.gastado=sq.egreso
						FROM 
			...
			For m = 1 To Month(Date.Today)
				...
				'Ingresos
				DbMan.edit("UPDATE hacienda SET hacienda." & current_month & "=sq.ingreso_" & current_month & "
				...
				'Egresos
				DbMan.edit("UPDATE hacienda SET hacienda." & current_month & "=sq.egreso_" & current_month & "
			...
			DbMan.edit("INSERT INTO ingresos(nombre, pertenece, anexo, inciso, item, rubro, subrubro, 
			...
			DbMan.edit("INSERT INTO egresos(nombre, pertenece, anexo, inciso, item, rubro, subrubro, 
											 partida, subpartida, autorizado, orden, sumado, 
											 mes1, mes2, mes3, mes4, mes5, mes6, mes7, mes8, mes9, mes10, mes11, mes12,
											 sumatodo, gastado, gastomes, fecha)
							SELECT nombre, pertenece, anexo, inciso, item, rubro, subrubro,
			...
			''Partida
			DbMan.edit("UPDATE egresos SET egresos.gastado=sq.total_egreso 
 ...
 WHERE egresos.pertenece=sq.pertenece 
   AND egresos.anexo=sq.anexo AND egresos.inciso='0'")
			...
			''Subpartida
			DbMan.edit("UPDATE ingresos SET ingresos.sumatodo=sq.total_ingreso 
