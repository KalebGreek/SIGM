Public Class CalcAnualImpUI
    ...
    Public Sub comercio()
        ...
        '        If CalculoAnual.sql.Comercio.VerificarCuota(dtab_cuenta, fila, cuota, periodo.Value, dtab_deuda) Then
        '            cuota_mod += CalculoAnual.sql.Comercio.InsertarCuota(dtab_cuenta, fila, cuota, periodo.Value, minimo, taecom,
        ...
        '    If CalculoAnual.sql.Comercio.VerificarCuota(dtab_cuenta, fila, 1, periodo.Value, dtab_deuda) Then
        '        cuota_mod += CalculoAnual.sql.Comercio.InsertarCuota(dtab_cuenta, fila, 1, periodo.Value, minimo, taecom,
        '                                                            franqueo, importe, dtab_vence(0))
        '    End If
        'End If
