Public Class ContenedorGen
    Public Sub New(user As Integer, tipo As Button)
        ...
        If tipo.Name = "cat" Then
            CatastroMenu.Visible = True
        ElseIf tipo.Name = "gob" Then
            GobiernoMenu.Visible = True
        ElseIf tipo.Name = "hac" Then
            HaciendaMenu.Visible = True
        ElseIf tipo.Name = "opr" Then
            OprivadasMenu.Visible = True
        ElseIf tipo.Name = "opu" Then
            OPublicasMenu.Visible = True
        ElseIf tipo.Name = "com" Then
            ComercioMenu.Visible = True
        ElseIf tipo.Name = "per" Then
            PersonaMenu.Visible = True
        End If
    End Sub
