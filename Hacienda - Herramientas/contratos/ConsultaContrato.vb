    ...
    Private Sub printCont_Click(sender As Object, e As EventArgs) Handles printCont.Click
        With bs_contrato
            If bs_contrato.Position > -1 And GenSearchControl1.vista.SelectedIndex > -1 Then
                ...
                parametros = ParamReporte.Contrato.DetalleContrato(parametros, .Current("inicio"),
                ...
                Dim certificado As New VisorReporte(titulo_reporte, ruta_acceso, parametros, Nothing, False)
