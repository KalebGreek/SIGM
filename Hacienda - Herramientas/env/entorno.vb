Module entorno
    ...
    Sub ConfigInit(instancia As Form)
        ...
        '### CONEXION FOX
        dtab_con = DbMan.read(My.Settings.DefaultCon, "SELECT * FROM opciones WHERE opcion='conexion_fox'")

		If dtab_con.Rows.Count > 0 Then
			My.Settings.foxcon = dtab_con(0)("valor")
		End If
        '### CONEXION PSQL
        dtab_con = DbMan.read(My.Settings.DefaultCon, "SELECT * FROM opciones WHERE opcion='conexion_sql'")
		If dtab_con.Rows.Count > 0 Then
